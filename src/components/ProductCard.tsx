	...
	return (
		<main className="border-border h-auto max-w-50 rounded-sm border bg-white shadow-md duration-200 ease-in-out hover:scale-105 hover:shadow-lg md:max-w-xs">
			...
			<div className="flex flex-col gap-2 p-5">
				...
				<p className="text-subtitle text-xs md:text-lg">
					{product_description}
				</p>
				...
				<div className="flex items-center justify-between">
					...
					<button className="bg-contrast hover:bg-contrast/5 w-2/5 rounded-sm p-1 text-xs text-white duration-200 ease-in-out md:p-2 md:text-lg">
						Detalhes
					</button>
				</div>
			</div>
